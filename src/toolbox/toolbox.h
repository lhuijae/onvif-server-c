...
//      Modify toolbox-config.h to add and remove features. For
...
#endif
#if C_TOOLBOX_XML == 1
#	include "toolbox-xml.h"
#endif
#if C_TOOLBOX_BINARY_TREE == 1
#	include "toolbox-btree.h"
#endif
...
int C_charToWide(const char * original, wchar_t * utf16, unsigned int utf16_size);
int C_utf8ToWide(const char * utf8, wchar_t * utf16, unsigned int utf16_size);
int C_utf8ToWideAlloc(const char * utf8, wchar_t ** utf16, unsigned int * utf16_size);
int C_utf16ToChar(const wchar_t * utf16, char * writeme, unsigned int writeme_size);
int C_utf16ToUtf8(const wchar_t * utf16, char * writeme, unsigned int writeme_size);

// convert &quot; to " and more
int C_DecodeXmlTextBlobs(char * source, char ** temp, unsigned int * temp_size);

// UTF-8 toolbox :)
// utf8_buffer_size can be -1 if you don't know.. but string MUST be terminated.
int C_utf8strlen(const char * utf8, int utf8_buffer_size);
...
extern FILE * g_toolbox_log_file;
#endif
...
#if defined(_MSC_VER)
#	if defined(atoi64)
#		define C_atoi64(a) atoi64(a)
#		define C_atoi64W(a) wtoi64(a)
#		define C_atoiW(a) wtoi(a)
#	else
#		define C_atoi64(a) _atoi64(a)
#		define C_atoi64W(a) _wtoi64(a)
#		define C_atoiW(a) _wtoi(a)
#	endif
#else
#	define C_atoi64(a) atoll(a)
#endif
