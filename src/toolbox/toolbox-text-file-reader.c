...
// DEVELOPER WARNING
//  if you modify this file, also modify toolbox-text-file-reader.cpp in the liveMedia_VS7 project
...
static int fseek64(FILE *fid, int64_t offset, int whence) 
{
	...
	return fseeko(fid, (off_t)(offset), whence);
	 // frank fixme is this available on uClibc
#endif
#endif
}
