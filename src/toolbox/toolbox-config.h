...
#define C_TOOLBOX_32BIT 1
#define C_TOOLBOX_WIDESTRINGS 0

#define C_TOOLBOX_CHARARRAY 1
#define C_TOOLBOX_NETWORK 1
#define C_TOOLBOX_HTTP_CLIENT 0
#define C_TOOLBOX_SOCKET_SERVER 1
#define C_TOOLBOX_SOCKET_CLIENT 1

#define C_TOOLBOX_LOGIN 0
#define C_TOOLBOX_TIMING 1
#define C_TOOLBOX_LOG_COMMAND 0

#define C_TOOLBOX_THREAD_AND_MUTEX 1

#define C_TOOLBOX_LINKED_LIST 1
#define C_TOOLBOX_CONFIG_MD5 0
#define C_TOOLBOX_CONFIG_INI_MANAGER 1
#define C_TOOLBOX_CGI 0
#define C_TOOLBOX_HTTP_SERVER 0
#define C_TOOLBOX_XML 1
#define C_TOOLBOX_GENERIC_TREE 1
#define C_TOOLBOX_BINARY_TREE 1
